...
\keywords{i523, hid208, Deep Learning, Big Data, Deep Belief Network, Convolutional Neural Network}
...
\begin{figure}[htp]
\centering
\includegraphics[width=\columnwidth]{images/paper1-fig1.png}
\caption{DBN}
\label{fig:1}
%\end{figure}
...
%\begin{figure}[htp]
\centering
\includegraphics[width=\columnwidth]{images/paper1-fig2.png}
\caption{CNN}
\label{fig:2}
%\end{figure}
...
%\begin{figure}[htp]
\centering
\includegraphics[width=\columnwidth]{images/paper1-figure3.png}
\caption{GPU}
\label{fig:3}
\end{figure}
